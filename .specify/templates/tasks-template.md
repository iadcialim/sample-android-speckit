...
- **Android App (as per constitution)**:
...
- Paths shown below assume a single project structure and should be adjusted based on the module structure defined in `plan.md`.
